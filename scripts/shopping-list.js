...
const shoppingList = (function(){
  ...
  function generateItemElement(item) {
    ...
    if (item.isEditing) {
      itemTitle =  `<form class="js-edit-item">
    ...
    return `<li class="js-item-element" data-item-id="${item.id}">
        ...
        <div class="shopping-item-controls">
          <button class="shopping-item-edit js-item-edit yellow" ${editBtnStatus}>
            <span class="button-label ">edit</span>
          </button>
          <button class="shopping-item-toggle js-item-toggle green">
            <span class="button-label">check</span>
          </button>
          <button class="shopping-item-delete js-item-delete red">
